    ...
    try:
        ...
        if action == 'like':
            ...
            if liker_profile:
                ...
                # Кнопки для лайка, дизлайка и пожаловаться
            ...
            # Убедитесь, что target_id действительно представляет собой пользователя, на которого пожаловались
...
def get_random_user(update: Update) -> dict:
    try:
        ...
        age_min = max(16, user_age - 50)
        age_max = min(80, user_age + 50)
